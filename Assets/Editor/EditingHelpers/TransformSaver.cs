/*
	TransformSaver.cs
	© Sat Jul  8 14:45:28 CDT 2006 Graveck Interactive
	by Jonathan Czeck
*/
using UnityEngine;
using UnityEditor;
...
public class TransformSaver : ScriptableObject
{
	...
	[MenuItem ("Custom/Transform Saver/Record Selected Transforms", false, 505)]
	...
	[MenuItem ("Custom/Transform Saver/Apply Saved Transforms", false, 506)]
	static void DoApply()
	{
